...
@WebServlet(urlPatterns = "/routeinstances")
public class RouteInstanceServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/routeInstances.jsp").forward(request, response);
    }
}
