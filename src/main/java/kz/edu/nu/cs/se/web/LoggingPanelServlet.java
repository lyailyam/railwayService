...
public class LoggingPanelServlet extends HttpServlet {

    public LoggingPanelServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("WEB-INF/jsp/logs.jsp").forward(request, response);
    }
}