...
@WebServlet(urlPatterns = "/schedule-map")
public class ScheduleMapServlet extends HttpServlet {

    public ScheduleMapServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("WEB-INF/jsp/scheduleMap.jsp").forward(request, response);
    }
}